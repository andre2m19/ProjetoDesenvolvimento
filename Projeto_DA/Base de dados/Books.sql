...
-- --------------------------------------------------
-- Date Created: 05/26/2021 12:33:43
-- Generated from EDMX file: C:\Users\Asus\Documents\GitHub\ProjetoDesenvolvimentoA\Projeto_DA\Base de dados\BooKids.edmx
-- --------------------------------------------------
...
CREATE TABLE [dbo].[Inscricaos] (
    ...
    [FilhosIdPessoa] int IDENTITY(1,1) NOT NULL,
    [EventosNrEvento] int IDENTITY(1,1) NOT NULL,
...
CREATE TABLE [dbo].[Colaboracaos] (
    [NrEvento] int IDENTITY(1,1) NOT NULL,
    [IdAnimador] int IDENTITY(1,1) NOT NULL,
    [Eventos_NrEvento] int  NOT NULL,
...
-- Creating primary key on [ComprasNrCompra], [ProdutosCodProduto] in table 'DetalheCompras'
...
-- Creating primary key on [NrCartao] in table 'Compras'
ALTER TABLE [dbo].[Compras]
ADD CONSTRAINT [PK_Compras]
    PRIMARY KEY CLUSTERED ([NrCartao] ASC);
GO
...
-- Creating foreign key on [Produtos_CodProduto] in table 'DetalheCompras'
ALTER TABLE [dbo].[DetalheCompras]
...
-- Creating foreign key on [Compras_NrCartao] in table 'DetalheCompras'
ALTER TABLE [dbo].[DetalheCompras]
ADD CONSTRAINT [FK_CompraDetalheCompra]
    FOREIGN KEY ([Compras_NrCartao])
...
-- Creating foreign key on [Eventos_NrEvento] in table 'Participacaos'
ALTER TABLE [dbo].[Participacaos]
...
-- Creating foreign key on [Escolas_IdEscola] in table 'Participacaos'
ALTER TABLE [dbo].[Participacaos]
